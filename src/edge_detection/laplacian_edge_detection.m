function image_edge_detection = laplacian_edge_detection(img, nKernel, kernel_str)
    ...
    if mod(nKernel, 2) == 0 || nKernel ~= floor(nKernel)
        ...
        laplacian_kernel = generate_laplacian_kernel(double(nKernel), kernel_str);
